...
export function WebSearchPanel(): React.JSX.Element {
  ...
  const providerOptions = [
    ...
    { value: 'google', label: 'Google', description: 'Background crawl, no API key needed' },
    { value: 'bing', label: 'Bing', description: 'Background crawl, no API key needed' },
    { value: 'baidu', label: 'Baidu', description: 'Background crawl, no API key needed' }
  ]
