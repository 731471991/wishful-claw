...
import { type FileChangeCardProps, type CompactActionOp, type ResolvedWritePayload, formatCompactCount, snapshotText, snapshotLineTotal, canRenderInlineSnapshot, computeDiff, summarizeDiff, resolveEditPayload, resolveWritePayload } from './FileChangeCard/utils'
