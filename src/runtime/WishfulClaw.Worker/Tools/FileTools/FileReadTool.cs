...
/// Adapted from OpenCowork AgentRuntimeNativeToolExecutor.ReadAsync.
/// </summary>
public sealed class FileReadTool : IToolExecutor
{
    ...
    public static JsonElement WriteSchema => ParseSchema(
    ...
    public static JsonElement EditSchema => ParseSchema(
