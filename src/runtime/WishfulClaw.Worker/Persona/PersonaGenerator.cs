...
/// </summary>
internal static class PersonaGenerator
{
        ...
        string? workingFolder)
    {
        ...
        var systemPrompt = BuildGenerationPrompt(referencePersonaId, workingFolder);
    ...
    private static string BuildGenerationPrompt(string? referencePersonaId, string? workingFolder)
    {
