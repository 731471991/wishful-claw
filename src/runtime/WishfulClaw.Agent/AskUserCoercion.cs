...
/// <summary>
/// Input coercion, validation, and utility methods for AskUserQuestion.
/// Extracted from AgentRuntimeAskUserExecutor for maintainability.
/// </summary>
internal static partial class AgentRuntimeAskUserExecutor
{
    ...
    private static AskUserOption? CoerceOption(JsonElement value)
    {
        ...
        return new AskUserOption(
            ...
            CoerceStringField(value, "description", "desc", "detail", "details", "impact", "rationale"),
